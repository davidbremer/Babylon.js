module BABYLON {
    export class TrackballCameraVRDeviceOrientationInput implements ICameraInput<TrackballCamera> {
        ...
        getTypeName(): string {
            return "TrackballCameraVRDeviceOrientationInput";
        }
    ...
    CameraInputTypes["TrackballCameraVRDeviceOrientationInput"] = TrackballCameraVRDeviceOrientationInput;
}
