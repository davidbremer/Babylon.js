module BABYLON {
    export class TrackballCameraMouseWheelInput implements ICameraInput<TrackballCamera> {
        ...
        getTypeName(): string {
            return "TrackballCameraMouseWheelInput";
        }
    ...
    CameraInputTypes["TrackballCameraMouseWheelInput"] = TrackballCameraMouseWheelInput;
}
