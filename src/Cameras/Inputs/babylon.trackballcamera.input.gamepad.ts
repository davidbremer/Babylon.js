module BABYLON {
    export class TrackballCameraGamepadInput implements ICameraInput<TrackballCamera> {
        ...
        getTypeName(): string {
            return "TrackballCameraGamepadInput";
        }
    ...
    CameraInputTypes["TrackballCameraGamepadInput"] = TrackballCameraGamepadInput;
}
